...
define([
    ...
    return Component.extend({
        ...
        isIdInCheckbox: function (id) {
            if(this.levelIdentifier == "orderLevel"){
                return 'gift_'+id;
            }else{
                return  id;
            }
        ...
        setActiveItem: function (id) {
            if(this.levelIdentifier == 'orderLevel'){
                if(jQuery('#gift_'+id).parent('li').hasClass('_active')) {
                    this.uncheckWrapping();
                    this.model.setActiveItem(id);
                    this.updateInfoBlock();
                    jQuery('#gift_'+id).parents('.content').find('.action-remove').click();
                    jQuery('#gift_'+id).parents('.content').find('.action-update').click();
                }else{
                    this.model.setActiveItem(id);
                    this.updateInfoBlock();
                    jQuery('#gift_'+id).parents('.content').find('.action-update').click();
