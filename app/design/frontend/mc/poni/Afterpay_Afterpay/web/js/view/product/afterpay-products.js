...
require(
    ...
    function ( $, priceUtils, quote ) {
        ...
        {
			if(jQuery('.price-box #giftcard-amount').length) 
			{
				var gift_price = jQuery('.price-box #giftcard-amount option:nth-child(2)').val();
				product_variant_price = gift_price;
				jQuery( ".price-box #giftcard-amount" ).change(function() {
					gift_price = jQuery(".price-box #giftcard-amount").val();
					product_variant_price = gift_price;
