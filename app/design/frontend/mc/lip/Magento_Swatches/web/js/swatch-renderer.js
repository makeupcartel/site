    ...
    $.widget('mage.SwatchRenderer', {
        ...
        _RenderControls: function () {
            ...
            $.each(this.options.jsonConfig.attributes, function () {
                ...
                if ($('.catalog-product-view .owl-carousel').length) {
                    setTimeout(function () {
        ...
        _RenderFormInput: function (config) {
            var textRequire = "Please select your shade";
            return '<input class="' + this.options.classes.attributeInput + ' super-attribute-select" ' +
                'name="super_attribute[' + config.id + ']" ' +
                'type="text" ' +
                'value="" ' +
                'data-msg-required="' + textRequire + ' " ' +
        ...
        _OnClick: function ($this, $widget) {
            ...
            if ($this.hasClass('disabled')) {
                $('#product-addtocart-button').attr("disabled", "disabled").addClass('disabled');
                $('#product-addtocart-button').text($widget.options.outOfStockText);
                $parent.find('.selected').removeClass('selected');
                $this.addClass('selected');
                if ($('.product-mobile-title .sticky-buttons').length) {
                    $('.product-mobile-title .sticky-buttons').hide();
                }
                return;
            } else {
                $('#product-addtocart-button').removeAttr("disabled").removeClass('disabled');
                $('#product-addtocart-button').text($widget.options.addToCartText);
                if ($('.product-mobile-title .sticky-buttons .sticky-atc-button').length) {
                    var price = $('.product-mobile-title .price-box.price-final_price [data-price-type="finalPrice"] .price').text();
                    if (price) {
                        $('.product-mobile-title .sticky-buttons .sticky-atc-button').text($widget.options.addToCartText + ' - ' + price);
                    } else {
                        /*$('.product-mobile-title .sticky-buttons .sticky-atc-button').text($widget.options.addToCartText);*/
                        // console.log(1);
                    }
                    $('.product-mobile-title .sticky-buttons').css('display', '');
                }
            }
