...
/**
 * Class Collection
 * @package Amasty\Reports\Model\ResourceModel\Sales\Orders
 */
class Collection extends \Magento\Sales\Model\ResourceModel\Order\Collection
{
     ...
     * @param $collection
     */
    public function createPeriod($collection)
    {
        $filters = $this->request->getParam('amreports');
        isset($filters['from']) ? $period[] = $filters['from'] : false;
        isset($filters['to']) ? $period[] = $filters['to'] : false;

        $collection->getSelect()
            ->columns(['period' => new \Zend_Db_Expr("'".implode('-', $period)."'") ]);
    }
}
