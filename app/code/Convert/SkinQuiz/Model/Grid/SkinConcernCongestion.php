...
class SkinConcernCongestion extends \Magento\Eav\Model\Entity\Attribute\Source\AbstractSource
{
	protected $eavConfig;
	...
	{
		if (!$this->_options) {
			$this->_options = $this->retrieveOptions('skin_concern_account_congestion');
        }
