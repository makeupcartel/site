...
class Category extends \Magento\Framework\Model\AbstractModel implements \Magento\Framework\DataObject\IdentityInterface
{
     ...
     * CMS page cache tag
     */
    const CACHE_TAG = 'convert_customercontent_category';

    /**
     * @var string
     */
    protected $_cacheTag = 'convert_customercontent_category';
    ...
    {
        $this->_init('Convert\CustomerContent\Model\ResourceModel\Category');
    }
