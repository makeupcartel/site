...
namespace Convert\CustomerContent\Block\Training;
 ...
 * Class Content
 *
 * @package Convert\CustomerContent\Block\Training
 */
class Content extends Template
{
    ...
    public function getContentCollection($categoryId)
    {
        $collection = $this->contentCollectionFactory->create()->addFieldToSelect('content_id')
            ->addFieldToSelect('thumbnail')->addFieldToSelect('title')->addFieldToSelect('file_path')
            ->addFieldToFilter('status', 1)
