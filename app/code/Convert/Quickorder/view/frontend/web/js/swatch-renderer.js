    ...
    $.widget('mage.SwatchRenderer', {
        ...
        _RenderSwatchOptions: function (config, controlId) {
            var optionConfig = this.options.jsonSwatchConfig[config.id],
                html = '<label class="label">'+config.code+'</label>';
            html += '<select class="swatch-select">';
            html += '<option value="0" option-id="0">Select Option</option>';
            ...
            html += '</select>';
            html += '<div generated="true" class="no-display mage-error">Please sellect one Option</div>';
            return html;
        },
        ...
        _OnClick: function ($this, $widget) {
            ...
            if ($('.product-info-main .product-add-form form #product-addtocart-button').length) {
                ...
                if (price) {
                    ...
                    $('.product-mobile-title-wrapper .sticky-buttons .sticky-atc-button').text(text);
                }
            }
            if ($('.product-info-main .product-info-price .price-box').length) {
                $('.product-mobile-title-wrapper .price-box').html($('.product-info-main .product-info-price .price-box').html());
            }
            /* END CUSTOM */
        },
